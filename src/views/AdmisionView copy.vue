                ...
                <div class="col-md-6 mt-3 mt-md-5">
                    ...
                    <div class="mb-1">
                        <ul class="requirements-list">
                            <li>
                                Copia del Título Profesional autenticado por el Fedatario de la Universidad de Origen si es egresado de otras universidades.
                            </li>
                            <li>Copia simple del Título Profesional para egresados de la Universidad Nacional de San Martín.</li>
                            <li>
                            ...
                            <li>
                                Recibos de pago por derecho de inscripción y/o admision.
                            </li>
